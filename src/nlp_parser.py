...
# data/processed/district_stats.csv ile uretilen 8 semt (src/data_prep.py::DISTRICT_PROFILES).
KNOWN_DISTRICTS = [
    "Görükle", "Özlüce", "Beşevler", "Nilüfer",
    "Çekirge", "Heykel", "Yıldırım", "Mudanya",
]
